...
import { PERMISSION_OPTIONS_ASSIGNED } from '@/components/features/permissions';
import { Button } from '@/components/ui/buttons';
import { Dropdown, type IDropdownItem } from '@/components/ui/dropdown';
...
const PermissionGroupAssignButton: React.FC<{
  ...
  const items: IDropdownItem<'true' | 'false'>[] = useMemo(() => {
