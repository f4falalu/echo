...
const assetCheckPages: BusterRoutes[] = [
  ...
  BusterRoutes.APP_CHAT_ID_DASHBOARD_ID_METRIC_ID_FILE,
  BusterRoutes.APP_CHAT_ID_DASHBOARD_ID_METRIC_ID_VERSION_NUMBER,
...
const assetRedirectRecord: Partial<Record<BusterRoutes, BusterRoutes>> = {
  ...
  [BusterRoutes.APP_CHAT_ID_DASHBOARD_ID_METRIC_ID_FILE]: BusterRoutes.EMBED_METRIC_ID,
  [BusterRoutes.APP_CHAT_ID_DASHBOARD_ID_METRIC_ID_VERSION_NUMBER]: BusterRoutes.EMBED_METRIC_ID,
