...
export const WithProblematicXAxisQuarter: Story = {
  args: {
    colors: [
      '#B399FD',
      '#FC8497',
    ...
    data: [
      {
        year: 2023,
        quarter: 2,
        metric_qoq_salesgrowthrate: 5.372278721135275,
      },
      {
        year: 2023,
        quarter: 3,
        metric_qoq_salesgrowthrate: 35.02527368847452,
      },
      {
        year: 2023,
        quarter: 4,
        metric_qoq_salesgrowthrate: 2.391177929746946,
      },
      {
        year: 2024,
        quarter: 1,
        metric_qoq_salesgrowthrate: -19.277232094329378,
      },
      {
        year: 2024,
        quarter: 2,
        metric_qoq_salesgrowthrate: 7.70139644758294,
      },
      {
        year: 2024,
        quarter: 3,
        metric_qoq_salesgrowthrate: 38.95753848578902,
      },
      {
        year: 2024,
        quarter: 4,
        metric_qoq_salesgrowthrate: 17.800138052087753,
      },
      {
        year: 2025,
        quarter: 1,
        metric_qoq_salesgrowthrate: -5.299916315807864,
      },
      {
        year: 2025,
        quarter: 2,
        metric_qoq_salesgrowthrate: 6.26104974814219,
      },
      {
        year: 2025,
        quarter: 3,
        metric_qoq_salesgrowthrate: -45.868163261472425,
      },
    ],
    columnMetadata: [
      {
      ...
      },
      {
        ...
        min_value: -45.868163261472425,
        max_value: 38.95753848578902,
        unique_values: 10,
        simple_type: 'number',
        type: 'numeric',
      },
...
export const WithProblematicXAxisQuarter2: Story = {
  args: {
    colors: [
      '#B399FD',
      '#FC8497',
    ...
    data: [
      {
        fiscal_quarter: 1,
        fiscal_year: 2024,
        quarterly_revenue: 8167805.1981,
      },
      {
        fiscal_quarter: 1,
        fiscal_year: 2025,
        quarterly_revenue: 13594780.2633,
      },
      {
        fiscal_quarter: 2,
        fiscal_year: 2024,
        quarterly_revenue: 8796451.8102,
      },
      {
        fiscal_quarter: 2,
        fiscal_year: 2025,
        quarterly_revenue: 14448044.519,
      },
      {
        fiscal_quarter: 3,
        fiscal_year: 2024,
        quarterly_revenue: 12262691.4094,
      },
      {
        fiscal_quarter: 3,
        fiscal_year: 2025,
        quarterly_revenue: 7799857.48,
      },
      {
        fiscal_quarter: 4,
        fiscal_year: 2024,
        quarterly_revenue: 14415296.7546,
      },
    ],
    columnMetadata: [
      {
      ...
      },
      {
        ...
        min_value: 7799857.48,
        max_value: 14448044.519,
        unique_values: 7,
        simple_type: 'number',
        type: 'numeric',
      },
