...
export const CollapisbleFileCard = ({
  fileName,
  className,
  children,
  collapsible,
  ...
  // Memoize the collapse click handler to avoid unnecessary re-renders and stale closures
  const handleCollapseClick = React.useMemo(
