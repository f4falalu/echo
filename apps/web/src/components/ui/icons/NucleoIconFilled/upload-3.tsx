...
function upload3(props: iconProps) {
  ...
  return (
    <svg height="1em" width="1em" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill="currentColor">
        <path
          d="m9.25,5h-2.5v3.75c0,.414-.336.75-.75.75s-.75-.336-.75-.75v-3.75h-2.5c-1.517,0-2.75,1.233-2.75,2.75v1.5c0,1.517,1.233,2.75,2.75,2.75h6.5c1.517,0,2.75-1.233,2.75-2.75v-1.5c0-1.517-1.233-2.75-2.75-2.75Z"
          fill="currentColor"
          strokeWidth="0"
        />
        <path
