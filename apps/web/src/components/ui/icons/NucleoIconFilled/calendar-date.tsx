  ...
  return (
    <svg height="1em" width="1em" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill="currentColor">
        ...
        />
        <path
          d="M9.25,13.5c-.414,0-.75-.336-.75-.75v-2.431c-.164,.067-.344,.122-.54,.16-.4,.075-.8-.189-.877-.596-.078-.407,.188-.8,.596-.878,.604-.116,.911-.613,.924-.634,.175-.289,.525-.427,.846-.34,.324,.09,.552,.381,.552,.718v4c0,.414-.336,.75-.75,.75Z"
          fill="currentColor"
        />
      </g>
    </svg>
