import type { BarAndLineAxis, ChartConfigProps, ChartType } from '@buster/server-shared/metrics';
...
> = ({
  ...
  const ComponentsLoop: {
    ...
    },
    {
      ...
      enabled: !isPieChart && !isComboChart,
      Component: (
        <EditHideYAxis hideYAxis={mostPermissiveHideYAxis} onUpdateYAxis={onUpdateYAxis} />
      ),
    },
    {
