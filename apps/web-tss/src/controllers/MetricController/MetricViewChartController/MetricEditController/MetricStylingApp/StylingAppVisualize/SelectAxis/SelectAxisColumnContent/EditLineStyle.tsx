...
import ChartArea from '@/components/ui/icons/NucleoIconOutlined/chart-area';
import ChartCombo from '@/components/ui/icons/NucleoIconOutlined/chart-combo';
import ChartLine from '@/components/ui/icons/NucleoIconOutlined/chart-line';
import ChartStep from '@/components/ui/icons/NucleoIconOutlined/chart-step-chart';
...
export const EditLineStyle: React.FC<{
  ...
  ({ selectedChartType, lineStyle, lineType, lineSymbolSize, onUpdateColumnSettingConfig }) => {
    ...
    const onChange = (value: SegmentedItem) => {
