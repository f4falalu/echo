...
function sidebarRight4Hide(props: iconProps) {
  ...
  return (
    <svg height="1em" width="1em" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill="currentColor">
        <path
          d="m4.25,9.75h1.9395l-.7197.7197c-.293.293-.293.7676,0,1.0605s.7676.293,1.0605,0l2-2c.293-.293.293-.7676,0-1.0605l-2-2c-.1465-.1465-.3384-.2197-.5303-.2197s-.3838.0732-.5303.2197c-.293.293-.293.7676,0,1.0605l.7197.7197h-1.9395c-.4141,0-.75.3359-.75.75s.3359.75.75.75Z"
          fill="currentColor"
          strokeWidth="0"
        />
        <path
