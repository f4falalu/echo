  ...
  return (
    <svg height="1em" width="1em" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill="currentColor">
        ...
        />
        <path
          d="M10,14.25c0-1.241,1.01-2.25,2.25-2.25h.25v-.25c0-1.241,1.01-2.25,2.25-2.25,.71,0,1.337,.337,1.75,.854V6.25c0-.414-.336-.75-.75-.75H7.5V2.75c0-.414-.336-.75-.75-.75h-2.5c-1.517,0-2.75,1.233-2.75,2.75V13.25c0,1.517,1.233,2.75,2.75,2.75h6.603c-.516-.413-.853-1.04-.853-1.75Z"
          fill="currentColor"
        />
        <path
