...
// Legacy input schema for backwards compatibility
...
// Legacy output schema for backwards compatibility
...
export const identifyAssumptionsStepExecution = async ({
  ...
  inputData: z.infer<typeof legacyInputSchema>;
}): Promise<z.infer<typeof legacyOutputSchema>> => {
  try {
