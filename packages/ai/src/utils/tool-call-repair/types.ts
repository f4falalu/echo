...
import type { ANALYST_AGENT_NAME, ANALYST_ENGINEER_AGENT_NAME, THINK_AND_PREP_AGENT_NAME } from '../../agents';

export interface AgentContext {
  agentName: typeof ANALYST_AGENT_NAME | typeof THINK_AND_PREP_AGENT_NAME | typeof ANALYST_ENGINEER_AGENT_NAME;
