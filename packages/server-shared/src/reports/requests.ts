...
export const UpdateReportRequestSchema = z
  .object({
    ...
    content: z.any().optional() as z.ZodOptional<z.ZodType<ReportElementsWithIds>>, //we use any here because we don't know the type of the content, will be validated in the database
  })
  .partial();
