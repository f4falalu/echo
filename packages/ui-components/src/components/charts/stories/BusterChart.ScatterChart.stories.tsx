...
import { generateScatterChartData } from './chartMocks';
import {
...
export const ProblematicDataset: Story = {
  args: {
    ...
    columnMetadata: scatterDataProblematic1.data_metadata.column_metadata as ColumnMetaData[],
    ...(scatterConfig_problematic1 as unknown as ChartConfigProps),
    barAndLineAxis: {
      x: ['eligible_orders'],
      y: ['attach_rate'],
      category: ['merchant'],
...
export const ProblematicDataset2: Story = {
  args: {
    ...Default.args,
    ...(scatterData_problematic2 as unknown as ChartConfigProps),
    data: scatterData_problematic2.data,
    columnMetadata: scatterData_problematic2.data_metadata.column_metadata as ColumnMetaData[],
    ...(scatterConfig_problematic2 as unknown as ChartConfigProps),
  },
};
