...
const columnMetadata: ColumnMetaData[] = Object.entries({
  ...
  max_value: 190,
  unique_values: 1000,
  simple_type: value === null ? 'text' : typeof value === 'number' ? 'number' : 'text',
