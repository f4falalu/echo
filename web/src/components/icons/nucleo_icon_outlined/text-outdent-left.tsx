...
function textOutdentLeft(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M15.25 10.75L8.75 10.75" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M15.25 7.25L8.75 7.25" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
