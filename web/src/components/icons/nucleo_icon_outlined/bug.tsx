...
function 18px_bug(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M9 15.25L9 10.75" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
