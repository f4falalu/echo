...
function 18px_ufo(props: iconProps) {
	...
	<g fill={fill}>
		...
		<ellipse cx="9.002" cy="7.34" fill={fill} rx="2.026" ry=".316" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth} transform="rotate(-9.918 9 7.342)"/>
	</g>
</svg>
	);
};

export default 18px_ufo;