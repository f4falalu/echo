...
function 18px_positionLeft(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<rect height="12.5" width="3.5" fill="none" rx="1" ry="1" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth} x="2.75" y="2.75"/>
...
export default 18px_positionLeft;