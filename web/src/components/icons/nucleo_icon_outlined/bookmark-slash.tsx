...
function 18px_bookmarkSlash(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M14.25 7.285L14.25 16.25 9 12.75 7.812 13.542" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
...
export default 18px_bookmarkSlash;