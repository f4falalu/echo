...
function 18px_award(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M12.25 13.75L12.25 17.25 9 14.75 5.75 17.25 5.75 13.75" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
