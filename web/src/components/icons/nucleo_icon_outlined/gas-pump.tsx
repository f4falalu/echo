...
function 18px_gasPump(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M1.75 15.75L13.25 15.75" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M3.25 8.75L11.75 8.75" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
