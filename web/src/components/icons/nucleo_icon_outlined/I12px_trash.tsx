...
function 12px_trash(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M1 2.25L11 2.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
