...
function 18px_squareCircleGroup(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M8.127,9.75c-.075,.238-.127,.487-.127,.75,0,1.381,1.119,2.5,2.5,2.5s2.5-1.119,2.5-2.5-1.119-2.5-2.5-2.5c-.263,0-.512,.052-.75,.127" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		...
		<path d="M5.25 5.25H9.75V9.75H5.25z" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
	</g>
</svg>
	);
};
