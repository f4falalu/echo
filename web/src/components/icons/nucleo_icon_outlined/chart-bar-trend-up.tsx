...
function 18px_chartBarTrendUp(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M6.25 2.75L8.75 2.75 8.75 5.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M8.5 3L2.75 8.75" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
	</g>
</svg>
	);
};
