...
function 18px_house9(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M11.652,12.152c-1.464,1.464-3.839,1.464-5.303,0" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
	</g>
</svg>
	);
};
