...
function 18px_positionCenter(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<rect height="4.5" width="4.5" fill="none" rx=".818" ry=".818" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth} transform="rotate(90 9 9)" x="6.75" y="6.75"/>
...
export default 18px_positionCenter;