...
function 18px_scissors(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M12.75 7.75L16.25 7.75" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M4 7.75L9.25 7.75" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
