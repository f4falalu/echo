...
function 18px_suitcase6(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M4.75 4.75L4.75 15.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M13.25 4.75L13.25 15.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
