...
function 18px_wifiOff(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M7.648,13.887c.238,.509,.752,.863,1.352,.863,.828,0,1.5-.672,1.5-1.5,0-.6-.353-1.114-.863-1.352" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
