...
function 18px_squareDashedDownload(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M11.75 9.5L9 12.25 6.25 9.5" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M9 12.25L9 5.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
