...
function 18px_gamingButtons(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M2.75 10.75L7.25 15.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
...
export default 18px_gamingButtons;