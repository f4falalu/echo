...
function 18px_isolatedCube(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M14.026 6.085L9 9 3.974 6.085" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M9 14.828L9 9" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
	</g>
</svg>
	);
};
