...
function 18px_progressBar(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M3.75 11.75L9 11.75" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
...
export default 18px_progressBar;