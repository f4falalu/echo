...
function 18px_batteryFull(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M4.25,11.25V6.75H13.25v4.5H4.25Z" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
	</g>
</svg>
	);
};

export default 18px_batteryFull;