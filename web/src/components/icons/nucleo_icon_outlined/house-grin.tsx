...
function 18px_houseGrin(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M8,11h2c.276,0,.5,.224,.5,.5h0c0,.828-.672,1.5-1.5,1.5h0c-.828,0-1.5-.672-1.5-1.5h0c0-.276,.224-.5,.5-.5Z" fill={secondaryfill}/>
		<circle cx="6.75" cy="9.75" fill={secondaryfill} r=".75"/>
		<circle cx="11.25" cy="9.75" fill={secondaryfill} r=".75"/>
	</g>
</svg>
	);
};
