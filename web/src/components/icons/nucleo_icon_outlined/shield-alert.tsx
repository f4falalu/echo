...
function 18px_shieldAlert(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M9 5.75L9 9.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M9,13c-.551,0-1-.449-1-1s.449-1,1-1,1,.449,1,1-.449,1-1,1Z" fill={secondaryfill}/>
	</g>
</svg>
	);
};

export default 18px_shieldAlert;