...
function 18px_vault3(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M9 11.75L9 10" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
