...
function 18px_suitcaseShield(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M16.25,8.799v-2.049c0-1.104-.895-2-2-2H3.75c-1.105,0-2,.896-2,2v6.5c0,1.104,.895,2,2,2h5.536" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
