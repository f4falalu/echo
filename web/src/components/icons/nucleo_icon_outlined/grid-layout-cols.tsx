...
function 18px_gridLayoutCols(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<rect height="12.5" width="4.5" fill="none" rx="1.5" ry="1.5" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth} x="10.75" y="2.75"/>
