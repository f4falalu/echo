...
function 18px_messageStar(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M16.25,8.979V4.25c0-1.104-.895-2-2-2H3.75c-1.105,0-2,.896-2,2v7c0,1.104,.895,2,2,2h2v3l2.981-2.385" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
