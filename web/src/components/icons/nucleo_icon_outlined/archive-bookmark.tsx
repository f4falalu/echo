...
function 18px_archiveBookmark(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="m9.25,2.75h-4.5c-1.105,0-2,.896-2,2v5.5" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="m16.25,7.25l-2.25-2.25-2.25,2.25V1.75c0-.5523.4477-1,1-1h2.5c.5523,0,1,.4477,1,1v5.5Z" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
	</g>
</svg>
	);
};
