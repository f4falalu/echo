...
function 12px_gift(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M6 3.75L6 10.75" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		...
		<path d="M11.25 3.75L0.75 3.75" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
