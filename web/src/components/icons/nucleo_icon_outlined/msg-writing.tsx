...
function 18px_msgWriting(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M9,10c-.552,0-1-.449-1-1s.448-1,1-1,1,.449,1,1-.448,1-1,1Z" fill={secondaryfill} opacity=".75"/>
		<path d="M5.5,10c-.552,0-1-.449-1-1s.448-1,1-1,1,.449,1,1-.448,1-1,1Z" fill={secondaryfill}/>
		<path d="M12.5,10c-.552,0-1-.449-1-1s.448-1,1-1,1,.449,1,1-.448,1-1,1Z" fill={secondaryfill} opacity=".5"/>
	</g>
</svg>
	);
};

export default 18px_msgWriting;