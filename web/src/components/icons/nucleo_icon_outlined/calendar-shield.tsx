...
function 18px_calendarShield(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M15.75,8.572v-3.822c0-1.104-.895-2-2-2H4.25c-1.105,0-2,.896-2,2V13.25c0,1.104,.895,2,2,2h5.036" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
