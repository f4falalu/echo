...
function 18px_arrowDoorIn(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M4 11.75L6.75 9 4 6.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M6.75 9L0.75 9" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
...
export default 18px_arrowDoorIn;