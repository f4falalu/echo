...
function 18px_tag3(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M10 12L8 10" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M12 10L10 8" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
