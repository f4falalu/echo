...
function 18px_shieldHalved(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M9 1.851L9 16.165" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
...
export default 18px_shieldHalved;