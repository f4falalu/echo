...
function 18px_envelopePen(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M16.25,8.274v-3.024c0-1.104-.895-2-2-2H3.75c-1.105,0-2,.896-2,2v7.5c0,1.104,.895,2,2,2h5.219" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
