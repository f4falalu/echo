...
function 18px_satellite(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M13.55 10.5L11.775 8.725" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<rect height="4.25" width="2.5" fill="none" rx="1" ry="1" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth} transform="rotate(135 5.972 2.972)" x="4.722" y=".847"/>
		<rect height="4.25" width="2.5" fill="none" rx="1" ry="1" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth} transform="rotate(135 15.028 12.028)" x="13.778" y="9.903"/>
	</g>
</svg>
	);
};

export default 18px_satellite;