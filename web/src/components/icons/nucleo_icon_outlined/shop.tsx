...
function 18px_shop(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M3.75 16.25L3.75 9.5" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M14.25 9.5L14.25 16.25" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
