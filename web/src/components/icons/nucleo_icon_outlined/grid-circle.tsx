...
function 18px_gridCircle(props: iconProps) {
	...
	<g fill={fill}>
		...
		<circle cx="13" cy="5" fill="none" r="2.5" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
...
export default 18px_gridCircle;