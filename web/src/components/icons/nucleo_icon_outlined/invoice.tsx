...
function 18px_invoice(props: iconProps) {
	...
	<g fill={fill}>
		...
		<circle cx="9" cy="6.5" fill="none" r="1.75" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
	</g>
</svg>
	);
};

export default 18px_invoice;