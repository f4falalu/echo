...
function 18px_keyboard2Cable(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M9,4.75v-.75c0-.966,.784-1.75,1.75-1.75h1.75c.793,0,1.462-.527,1.677-1.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
