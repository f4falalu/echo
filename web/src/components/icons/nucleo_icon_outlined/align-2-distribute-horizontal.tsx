...
function 18px_align2DistributeHorizontal(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<rect height="10.5" width="4.5" fill="none" rx="1" ry="1" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth} x="6.75" y="3.75"/>
...
export default 18px_align2DistributeHorizontal;