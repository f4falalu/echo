...
function 18px_shield2(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M9 1.847L9 16.153" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M2.75 8.75L15.25 8.75" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
