...
function 18px_arrowPerspDoorIn(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M9.75,3.75l4.158-1.512c.652-.237,1.342,.246,1.342,.94V14.822c0,.694-.69,1.177-1.342,.94l-4.158-1.512" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
