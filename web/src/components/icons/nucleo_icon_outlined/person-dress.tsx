...
function 18px_personDress(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<circle cx="9.001" cy="2.5" fill="none" r="1.75" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
...
export default 18px_personDress;