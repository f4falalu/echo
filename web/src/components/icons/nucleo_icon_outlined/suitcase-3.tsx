...
function 18px_suitcase3(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M9 9.25L9 11.5" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
