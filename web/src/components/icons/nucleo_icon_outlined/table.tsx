...
function 18px_table(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M5.75 2.75L5.75 15.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
