...
function 18px_squareDashedUpload(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M6.25 8.5L9 5.75 11.75 8.5" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M9 5.75L9 12.75" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
