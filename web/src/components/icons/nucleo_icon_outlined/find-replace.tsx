...
function 18px_findReplace(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M9.694,6.306c.026-.183,.056-.366,.056-.556,0-2.209-1.791-4-4-4S1.75,3.541,1.75,5.75s1.791,4,4,4c.191,0,.373-.03,.556-.056" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<rect height="7.5" width="7.5" fill="none" rx="1.5" ry="1.5" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth} x="8.75" y="8.75"/>
	</g>
</svg>
	);
};
