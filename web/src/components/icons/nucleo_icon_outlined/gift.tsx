...
function 18px_gift(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M9 5.25L9 16.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
