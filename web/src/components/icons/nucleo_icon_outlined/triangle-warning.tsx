...
function 18px_triangleWarning(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M9 6.5L9 10" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
...
export default 18px_triangleWarning;