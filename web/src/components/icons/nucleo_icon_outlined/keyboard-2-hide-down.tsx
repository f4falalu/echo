...
function 18px_keyboard2HideDown(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<rect height="10.5" width="14.5" fill="none" rx="2" ry="2" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth} x="1.75" y="1.75"/>
		...
		<path d="M11.25 9.25L6.75 9.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
