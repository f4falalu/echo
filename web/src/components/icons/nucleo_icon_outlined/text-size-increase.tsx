...
function 18px_textSizeIncrease(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M13.75 7.25L13.75 12.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
...
export default 18px_textSizeIncrease;