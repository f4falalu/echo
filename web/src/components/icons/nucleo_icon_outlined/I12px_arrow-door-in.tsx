...
function 12px_arrowDoorIn(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M0.75 6L5 6" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M3 3.75L5.25 6 3 8.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
...
export default 12px_arrowDoorIn;