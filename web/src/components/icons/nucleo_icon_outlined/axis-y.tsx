...
function 18px_axisY(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M9.725 4.237L7.25 1.763 4.775 4.237" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M7.25 10.75L7.25 1.75" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
