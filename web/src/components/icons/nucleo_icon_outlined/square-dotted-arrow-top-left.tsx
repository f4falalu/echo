...
function 18px_squareDottedArrowTopLeft(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M8.75 2.75L8.75 8.75 2.75 8.75" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M8.75 8.75L2.75 2.75" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
	</g>
</svg>
	);
};

export default 18px_squareDottedArrowTopLeft;