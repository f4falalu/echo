...
function 18px_laptopChartLine(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M12.75,7.5l-2.146,2.146c-.195,.195-.512,.195-.707,0l-1.793-1.793c-.195-.195-.512-.195-.707,0l-2.146,2.146" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
