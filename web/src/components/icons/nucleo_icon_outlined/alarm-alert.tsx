...
function 18px_alarmAlert(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M9,13c-.552,0-1-.449-1-1s.448-1,1-1,1,.449,1,1-.448,1-1,1Z" fill={secondaryfill}/>
		<path d="M9 6L9 9.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
...
export default 18px_alarmAlert;