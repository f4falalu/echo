...
function 18px_clipboardContent(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M6.25 8.75L11.75 8.75" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
...
export default 18px_clipboardContent;