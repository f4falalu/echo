...
function 18px_calendarPen(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M15.75,8.275v-3.525c0-1.104-.895-2-2-2H4.25c-1.105,0-2,.896-2,2V13.25c0,1.104,.895,2,2,2h4.546" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
