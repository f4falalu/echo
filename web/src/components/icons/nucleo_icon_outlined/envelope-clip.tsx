...
function 18px_envelopeClip(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M16.25,9.714V5.25c0-1.104-.895-2-2-2H3.75c-1.105,0-2,.896-2,2v7.5c0,1.104,.895,2,2,2h6" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
