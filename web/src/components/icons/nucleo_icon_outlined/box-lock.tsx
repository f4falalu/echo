...
function 18px_boxLock(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M15.25,8.394v-1.144c0-1.104-.895-2-2-2H4.75c-1.105,0-2,.896-2,2v6c0,1.104,.895,2,2,2h4" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
