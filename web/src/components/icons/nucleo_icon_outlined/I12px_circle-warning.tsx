...
function 12px_circleWarning(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M6 3.5L6 6.5" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
	</g>
</svg>
	);
};

export default 12px_circleWarning;