...
function 12px_paperPlane2(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M10.961 1.039L4.82 7.18" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
...
export default 12px_paperPlane2;