...
function 18px_userShortHair4(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M12.615,7.5c.088-.318,.135-.654,.135-1,0-2.071-1.679-3.75-3.75-3.75s-3.75,1.679-3.75,3.75c0,.346,.047,.682,.135,1h.381c-.009-.826,.659-1.5,1.484-1.5h3.5c.826,0,1.493,.674,1.484,1.5h.381Z" fill={fill} opacity=".3"/>
