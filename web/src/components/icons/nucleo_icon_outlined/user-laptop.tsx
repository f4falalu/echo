...
function 18px_userLaptop(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M8.75 16.25L5.75 16.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
	</g>
</svg>
	);
};

export default 18px_userLaptop;