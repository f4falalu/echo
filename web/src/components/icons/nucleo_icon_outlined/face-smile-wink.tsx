...
function 18px_faceSmileWink(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M10,9.25c.138-.105,.604-.432,1.281-.422,.639,.01,1.077,.314,1.219,.422" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
