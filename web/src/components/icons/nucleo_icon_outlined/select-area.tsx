...
function 18px_selectArea(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M7.75 15.25L8.75 15.25" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M15.25 7.75L15.25 8.75" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
