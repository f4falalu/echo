...
function 18px_houseBolt(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M9.917 10.75L7 10.75 9 7.5 8.083 10.25 11 10.25 9 13.5 9.917 10.75z" fill={secondaryfill} stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
	</g>
</svg>
	);
};
