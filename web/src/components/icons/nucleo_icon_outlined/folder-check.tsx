...
function 18px_folderCheck(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M15.75,9.764v-1.014c0-1.104-.895-2-2-2H4.25c-1.105,0-2,.896-2,2v4.5c0,1.104,.895,2,2,2h5.549" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
