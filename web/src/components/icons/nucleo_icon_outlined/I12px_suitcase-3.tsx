...
function I12px_suitcase3(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M6 8.75L6 6.75" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
...
export default I12px_suitcase3;