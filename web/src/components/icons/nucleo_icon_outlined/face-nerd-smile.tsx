...
function 18px_faceNerdSmile(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M11.25,12.258c-.472,.746-1.304,1.242-2.25,1.242s-1.778-.496-2.25-1.242" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
