...
function 18px_sidebarLeft2Hide(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M9.5 6.75L7.25 9 9.5 11.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M7.25 9L13.25 9" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
...
export default 18px_sidebarLeft2Hide;