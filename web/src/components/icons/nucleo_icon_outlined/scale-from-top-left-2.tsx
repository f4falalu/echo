...
function 18px_scaleFromTopLeft2(props: iconProps) {
	...
	<g fill={fill}>
		...
		<rect height="6" width="6" fill="none" rx="2" ry="2" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth} x="2.75" y="2.75"/>
	</g>
</svg>
	);
};

export default 18px_scaleFromTopLeft2;