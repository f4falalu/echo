...
function 12px_location2(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M6 5.25L6 9" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
