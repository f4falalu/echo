...
function 18px_positionTopLeft(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<rect height="5.5" width="5.5" fill="none" rx="1" ry="1" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth} transform="rotate(90 5.5 5.5)" x="2.75" y="2.75"/>
...
export default 18px_positionTopLeft;