...
function 18px_clipboardSlash(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M2.25 16.25L16 2.5" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
...
export default 18px_clipboardSlash;