...
function 18px_msgContent(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M5.75 10.75L10.25 10.75" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
	</g>
</svg>
	);
};

export default 18px_msgContent;