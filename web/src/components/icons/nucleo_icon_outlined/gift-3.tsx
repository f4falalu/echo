...
function 18px_gift3(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M7 5H11V8H7z" fill={secondaryfill}/>
		<path d="M7,10v2.499c0,.202,.122,.385,.309,.462,.187,.079,.401,.035,.545-.108l1.146-1.146,1.146,1.146c.096,.096,.224,.146,.354,.146,.064,0,.13-.012,.191-.038,.187-.077,.309-.26,.309-.462v-2.499H7Z" fill={secondaryfill}/>
