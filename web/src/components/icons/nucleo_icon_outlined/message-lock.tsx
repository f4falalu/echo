...
function 18px_messageLock(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M16.25,7.803v-3.553c0-1.104-.895-2-2-2H3.75c-1.105,0-2,.896-2,2v7c0,1.104,.895,2,2,2h2v3l3-2.4" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
