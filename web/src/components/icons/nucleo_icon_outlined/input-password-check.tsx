...
function 18px_inputPasswordCheck(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M16.25,8.471v-1.721c0-1.104-.895-2-2-2H3.75c-1.105,0-2,.896-2,2v4.5c0,1.104,.895,2,2,2h6.052" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
