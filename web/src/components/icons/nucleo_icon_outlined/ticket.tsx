...
function 18px_ticket(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M6.25 7.25H11.75V10.75H6.25z" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
