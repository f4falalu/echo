...
function 18px_refresh2(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M8.5 12.75L10.75 15 8.5 17.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		...
		<path d="M9.5 5.25L7.25 3 9.5 0.75" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
