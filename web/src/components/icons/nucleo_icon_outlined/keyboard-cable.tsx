...
function 18px_keyboardCable(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M11.75 10.25L6.25 10.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
...
export default 18px_keyboardCable;