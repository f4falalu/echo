...
function 18px_mobileWave2(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M1.75,9.25h3.76c.44,0,.828-.287,.956-.708l.999-3.27c.049-.161,.276-.163,.328-.003l2.414,7.46c.052,.16,.279,.158,.328-.003l.999-3.27c.128-.421,.517-.708,.956-.708h3.76" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
	</g>
</svg>
	);
};
