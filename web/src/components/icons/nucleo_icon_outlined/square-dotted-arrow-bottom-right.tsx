...
function 18px_squareDottedArrowBottomRight(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M9.25 15.25L9.25 9.25 15.25 9.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M9.25 9.25L15.25 15.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
	</g>
</svg>
	);
};

export default 18px_squareDottedArrowBottomRight;