...
function 18px_textHighlight(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M6.545 15.25L14.25 15.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		...
		<path d="M6.77 14.804L6.545 15.25 3.75 15.25 4.539 13.677" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
	</g>
</svg>
	);
};

export default 18px_textHighlight;