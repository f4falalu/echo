...
function 18px_target(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M9 9L12.25 5.75" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M12.25 5.75L12.25 3.5 14.75 1 14.75 3.25 17 3.25 14.5 5.75 12.25 5.75z" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
