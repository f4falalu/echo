...
function 18px_archiveContent(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M15.25,10.25V4.75c0-1.104-.895-2-2-2H4.75c-1.105,0-2,.896-2,2v5.5" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
