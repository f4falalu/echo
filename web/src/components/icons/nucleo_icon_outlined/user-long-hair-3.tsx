...
function 18px_userLongHair3(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M5.25,6.75c0,2.667,0,3.833-1.5,5" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M12.75,6.75c0,2.667,0,3.833,1.5,5" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
	</g>
</svg>
	);
};

export default 18px_userLongHair3;