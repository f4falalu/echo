...
function 18px_tableLock(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M15.25,7.802v-3.052c0-1.104-.895-2-2-2H4.75c-1.105,0-2,.896-2,2V13.25c0,1.104,.895,2,2,2h3" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
