...
function 12px_circleInfo(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M6 8.5L6 5.5" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
	</g>
</svg>
	);
};

export default 12px_circleInfo;