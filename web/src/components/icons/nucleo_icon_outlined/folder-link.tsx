...
function 18px_folderLink(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M15.75,10.75v-2c0-1.104-.895-2-2-2H4.25c-1.105,0-2,.896-2,2v4.5c0,1.104,.895,2,2,2h4" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
