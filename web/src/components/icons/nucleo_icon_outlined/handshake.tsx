...
function 18px_handshake(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M12.345 11.75L15.25 11.75" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
