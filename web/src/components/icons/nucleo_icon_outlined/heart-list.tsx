...
function 18px_heartList(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M15.804,8.25c.126-.521,.196-1.068,.196-1.641,.008-2.12-1.704-3.846-3.826-3.859-1.277,.016-2.464,.66-3.173,1.72-.71-1.06-1.897-1.704-3.173-1.72-2.123,.013-3.834,1.739-3.826,3.859,0,4.826,4.959,7.794,6.529,8.613,.149,.077,.31,.116,.471,.116" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
