...
function 18px_octagonInfo(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M9 12.819L9 8.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M9,4.75c-.551,0-1,.449-1,1s.449,1,1,1,1-.449,1-1-.449-1-1-1Z" fill={secondaryfill}/>
...
export default 18px_octagonInfo;