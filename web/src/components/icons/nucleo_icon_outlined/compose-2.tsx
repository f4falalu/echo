...
function 18px_compose2(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M15.25,8.75v4.5c0,1.105-.895,2-2,2H4.75c-1.105,0-2-.895-2-2V4.75c0-1.105,.895-2,2-2h4.5" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
