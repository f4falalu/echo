...
function 18px_databaseCheck(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M2.75,4.25V13.75c0,1.243,2.798,2.25,6.25,2.25,.12,0,.24-.001,.358-.004" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		...
		<path d="M11.744 15.25L13.353 16.75 16.75 12.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
	</g>
</svg>
	);
};
