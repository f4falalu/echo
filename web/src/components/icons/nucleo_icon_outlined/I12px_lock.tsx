...
function 12px_lock(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M6 7.5L6 8.5" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
