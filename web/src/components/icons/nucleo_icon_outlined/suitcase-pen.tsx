...
function 18px_suitcasePen(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M16.25,8.274v-1.524c0-1.104-.895-2-2-2H3.75c-1.105,0-2,.896-2,2v6.5c0,1.104,.895,2,2,2h5.046" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
