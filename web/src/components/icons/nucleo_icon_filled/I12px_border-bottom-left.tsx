...
function 12px_borderBottomLeft(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="m10.75,11.5H1.25c-.414,0-.75-.336-.75-.75V1.25c0-.414.336-.75.75-.75s.75.336.75.75v8.75h8.75c.414,0,.75.336.75.75s-.336.75-.75.75Z" fill={fill} strokeWidth="0"/>
	</g>
</svg>
	);
};

export default 12px_borderBottomLeft;