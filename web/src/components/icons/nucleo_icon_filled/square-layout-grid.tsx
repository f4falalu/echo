...
function 18px_squareLayoutGrid(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M9.75,8.25h6.25v-3.5c0-1.517-1.233-2.75-2.75-2.75h-3.5v6.25Z" fill={secondaryfill}/>
...
export default 18px_squareLayoutGrid;