...
function 18px_circleCheckPlus2(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M14.595,4.812l1.247-1.601c.255-.327,.196-.798-.131-1.053-.327-.255-.799-.196-1.053,.131l-1.099,1.411c.385,.331,.731,.705,1.036,1.111Z" fill={fill}/>
	</g>
</svg>
	);
};
