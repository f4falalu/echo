...
function 12px_ascendingSorting(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="m11.78,5.97l-2.5-2.5c-.293-.293-.768-.293-1.061,0l-2.5,2.5c-.293.293-.293.768,0,1.061s.768.293,1.061,0l1.22-1.22v5.439c0,.414.336.75.75.75s.75-.336.75-.75v-5.439l1.22,1.22c.146.146.338.22.53.22s.384-.073.53-.22c.293-.293.293-.768,0-1.061Z" fill={secondaryfill} strokeWidth="0"/>
...
export default 12px_ascendingSorting;