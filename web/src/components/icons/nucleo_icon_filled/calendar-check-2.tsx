...
function 18px_calendarCheck2(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M8.205,13.25c-.189,0-.372-.071-.511-.202l-1.43-1.333c-.303-.282-.32-.757-.037-1.06,.283-.303,.757-.319,1.06-.037l.822,.766,2.519-3.336c.25-.329,.719-.395,1.051-.146,.331,.25,.396,.72,.146,1.051l-3.02,4c-.128,.169-.322,.276-.534,.295-.021,.002-.043,.003-.065,.003Z" fill={secondaryfill}/>
	</g>
</svg>
	);
};

export default 18px_calendarCheck2;