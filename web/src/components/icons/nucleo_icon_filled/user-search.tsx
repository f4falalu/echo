...
function 18px_userSearch(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M8.5,13c0-1.599,.844-2.997,2.104-3.795-.521-.124-1.055-.205-1.604-.205-2.764,0-5.274,1.636-6.395,4.167-.257,.58-.254,1.245,.008,1.825,.268,.591,.777,1.043,1.399,1.239,1.618,.51,3.296,.769,4.987,.769,.597,0,1.191-.044,1.783-.108-1.356-.776-2.283-2.22-2.283-3.892Z" fill={fill}/>
...
export default 18px_userSearch;