...
function 18px_musicNote2Sparkle(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M14.908,6.359c.199-.364,.064-.819-.299-1.018-2.539-1.385-4.21-3.969-4.227-3.995-.18-.281-.521-.41-.843-.316-.319,.094-.54,.387-.54,.72V10.269c-.629-.476-1.403-.769-2.25-.769-2.068,0-3.75,1.682-3.75,3.75s1.682,3.75,3.75,3.75,3.75-1.682,3.75-3.75V3.915c.82,.903,1.977,1.972,3.391,2.743,.363,.198,.82,.065,1.018-.299Z" fill={fill}/>
		<path d="M3.23,8.217l.316-.947,.946-.315c.153-.051,.257-.194,.257-.356s-.104-.305-.257-.356l-.946-.315-.316-.947c-.102-.306-.609-.306-.711,0l-.316,.947-.946,.315c-.153,.051-.257,.194-.257,.356s.104,.305,.257,.356l.946,.315,.316,.947c.051,.153,.194,.256,.355,.256s.305-.104,.355-.256Z" fill={secondaryfill}/>
