...
function 18px_calendarPlus2(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M11,10h-1.25v-1.25c0-.414-.336-.75-.75-.75s-.75,.336-.75,.75v1.25h-1.25c-.414,0-.75,.336-.75,.75s.336,.75,.75,.75h1.25v1.25c0,.414,.336,.75,.75,.75s.75-.336,.75-.75v-1.25h1.25c.414,0,.75-.336,.75-.75s-.336-.75-.75-.75Z" fill={secondaryfill}/>
