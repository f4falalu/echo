...
function 18px_scaleFromTopLeft(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M2.75,4.75v4.25H7.25c.965,0,1.75-.785,1.75-1.75V2.75H4.75c-1.105,0-2,.896-2,2Z" fill={secondaryfill}/>
...
export default 18px_scaleFromTopLeft;