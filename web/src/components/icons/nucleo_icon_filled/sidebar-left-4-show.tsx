...
function 18px_sidebarLeft4Show(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="m14.2803,8.4697l-2-2c-.293-.293-.7676-.293-1.0605,0s-.293.7676,0,1.0605l.7197.7197h-1.9395c-.4141,0-.75.3359-.75.75s.3359.75.75.75h1.9395l-.7197.7197c-.293.293-.293.7676,0,1.0605.1465.1465.3379.2197.5303.2197s.3838-.0732.5303-.2197l2-2c.293-.293.293-.7676,0-1.0605Z" fill={secondaryfill} strokeWidth="0"/>
