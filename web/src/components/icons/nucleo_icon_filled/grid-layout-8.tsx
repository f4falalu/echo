...
function 18px_gridLayout8(props: iconProps) {
	...
	<g fill={fill}>
		...
		<rect height="4" width="4" fill={secondaryfill} rx="1.75" ry="1.75" strokeWidth="0" x="7" y="7"/>
		<rect height="9" width="4" fill={fill} rx="1.75" ry="1.75" strokeWidth="0" x="12" y="7"/>
		<rect height="4" width="4" fill={secondaryfill} rx="1.75" ry="1.75" strokeWidth="0" x="7" y="12"/>
