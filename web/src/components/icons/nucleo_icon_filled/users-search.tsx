...
function 18px_usersSearch(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M9,13c0-1.276,.539-2.423,1.394-3.242-.991-.643-2.159-1.008-3.394-1.008-2.369,0-4.505,1.315-5.575,3.432-.282,.557-.307,1.213-.069,1.801,.246,.607,.741,1.079,1.358,1.293,1.384,.48,2.826,.724,4.286,.724,.977,0,1.945-.119,2.894-.335-.554-.748-.894-1.664-.894-2.665Z" fill={fill}/>
...
export default 18px_usersSearch;