...
function 18px_tableRows2(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M1,12.5v.75c0,1.517,1.233,2.75,2.75,2.75H14.25c1.517,0,2.75-1.233,2.75-2.75v-.75H1Z" fill={fill}/>
	</g>
</svg>
	);
};

export default 18px_tableRows2;