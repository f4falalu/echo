...
function 12px_borderTopRight(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="m10.75,11.5c-.414,0-.75-.336-.75-.75V2H1.25c-.414,0-.75-.336-.75-.75s.336-.75.75-.75h9.5c.414,0,.75.336.75.75v9.5c0,.414-.336.75-.75.75Z" fill={fill} strokeWidth="0"/>
	</g>
</svg>
	);
};

export default 12px_borderTopRight;