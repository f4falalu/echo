...
function keyboard4Cable(props: iconProps) {
  ...
  return (
    <svg height={height} width={width} viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill={fill}>
        <path
          d="M9,5.5c-.414,0-.75-.336-.75-.75v-.75c0-1.378,1.121-2.5,2.5-2.5h1.75c.439,0,.834-.294,.959-.714,.119-.396,.529-.626,.934-.504,.396,.119,.622,.536,.504,.933-.313,1.051-1.299,1.786-2.396,1.786h-1.75c-.552,0-1,.449-1,1v.75c0,.414-.336,.75-.75,.75Z"
          fill={secondaryfill}
        />
        <path
