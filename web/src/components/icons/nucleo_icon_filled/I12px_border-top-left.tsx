...
function 12px_borderTopLeft(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="m1.25,11.5c-.414,0-.75-.336-.75-.75V1.25c0-.414.336-.75.75-.75h9.5c.414,0,.75.336.75.75s-.336.75-.75.75H2v8.75c0,.414-.336.75-.75.75Z" fill={fill} strokeWidth="0"/>
	</g>
</svg>
	);
};
