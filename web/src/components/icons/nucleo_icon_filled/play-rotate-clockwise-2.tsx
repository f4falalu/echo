...
function playRotateClockwise2(props: iconProps) {
	...
	const title = props.title || "play rotate clockwise 2";
	...
	<g fill={fill}>
		...
		<path d="m12.03,7.921l-3.651-2.129c-.385-.225-.865-.228-1.252-.005-.387.223-.627.638-.627,1.084v4.259c0,.446.24.861.627,1.084.192.11.408.165.623.165.218,0,.436-.057.63-.17l3.65-2.128c.389-.226.621-.629.621-1.079,0-.45-.231-.854-.62-1.081h0Z" fill={secondaryfill} strokeWidth="0"/>
	</g>
</svg>
	);
};
