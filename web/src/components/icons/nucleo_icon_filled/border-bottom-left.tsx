...
function 18px_borderBottomLeft(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M15.25,14.5H3.5V2.75c0-.414-.336-.75-.75-.75s-.75,.336-.75,.75V15.25c0,.414,.336,.75,.75,.75H15.25c.414,0,.75-.336,.75-.75s-.336-.75-.75-.75Z" fill={secondaryfill}/>
	</g>
</svg>
	);
};

export default 18px_borderBottomLeft;