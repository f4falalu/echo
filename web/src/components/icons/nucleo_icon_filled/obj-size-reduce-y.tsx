...
function 18px_objSizeReduceY(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M8.47,4.28c.146,.146,.338,.22,.53,.22s.384-.073,.53-.22l2.25-2.25c.293-.293,.293-.768,0-1.061s-.768-.293-1.061,0l-1.72,1.72-1.72-1.72c-.293-.293-.768-.293-1.061,0s-.293,.768,0,1.061l2.25,2.25Z" fill={fill}/>
...
export default 18px_objSizeReduceY;