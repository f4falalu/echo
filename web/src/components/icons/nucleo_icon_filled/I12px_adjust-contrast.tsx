...
function 12px_adjustContrast(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="m6,.75v10.5c2.899,0,5.25-2.351,5.25-5.25S8.899.75,6,.75Z" fill={secondaryfill} strokeWidth="0"/>
...
export default 12px_adjustContrast;