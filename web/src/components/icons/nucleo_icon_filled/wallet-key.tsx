...
function 18px_walletKey(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M9.25,13h-3.878c-.321-1.011-1.257-1.75-2.372-1.75-1.378,0-2.5,1.122-2.5,2.5s1.122,2.5,2.5,2.5c1.115,0,2.051-.739,2.372-1.75h1.628v1c0,.414,.336,.75,.75,.75s.75-.336,.75-.75v-1h.75c.414,0,.75-.336,.75-.75s-.336-.75-.75-.75Zm-6.25,1.75c-.551,0-1-.449-1-1s.449-1,1-1,1,.449,1,1-.449,1-1,1Z" fill={secondaryfill}/>
	</g>
</svg>
	);
};
