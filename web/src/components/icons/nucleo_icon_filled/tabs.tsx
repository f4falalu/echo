...
function 18px_tabs(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M15.75,5.5H7.5V2.75c0-.414-.336-.75-.75-.75h-2.5c-1.517,0-2.75,1.233-2.75,2.75V13.25c0,1.517,1.233,2.75,2.75,2.75H13.75c1.517,0,2.75-1.233,2.75-2.75V6.25c0-.414-.336-.75-.75-.75Z" fill={fill}/>
	</g>
</svg>
	);
};
