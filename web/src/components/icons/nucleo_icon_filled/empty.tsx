...
function 18px_empty(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M5.91,15.271c.933,.462,1.98,.729,3.09,.729,3.86,0,7-3.14,7-7,0-1.11-.267-2.156-.728-3.09L5.91,15.271Z" fill={fill}/>
		<path d="M13.947,4.053c-1.268-1.268-3.018-2.053-4.947-2.053-3.86,0-7,3.14-7,7,0,1.93,.785,3.68,2.053,4.947L13.947,4.053Z" fill={fill}/>
