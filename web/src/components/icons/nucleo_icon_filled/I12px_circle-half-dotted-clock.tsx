...
function 12px_circleHalfDottedClock(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="m6,12c-.414,0-.75-.336-.75-.75s.336-.75.75-.75c2.481,0,4.5-2.019,4.5-4.5,0-2.481-2.02-4.5-4.5-4.5-.414,0-.75-.336-.75-.75s.336-.75.75-.75c3.308,0,6,2.691,6,6,0,3.309-2.691,6-6,6Z" fill={fill} strokeWidth="0"/>
		<path d="m8,8.5c-.175,0-.351-.061-.493-.186l-2-1.75c-.163-.143-.256-.348-.256-.564v-2.75c0-.414.336-.75.75-.75s.75.336.75.75v2.41l1.744,1.526c.312.273.344.747.071,1.058-.148.169-.356.256-.565.256Z" fill={secondaryfill} strokeWidth="0"/>
...
export default 12px_circleHalfDottedClock;