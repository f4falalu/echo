...
function 18px_circleImage(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M13.194,8.384c-1.072-1.072-2.816-1.072-3.889,0L3.726,13.964c1.322,1.404,3.193,2.286,5.274,2.286,3.266,0,6.025-2.159,6.933-5.128l-2.738-2.738Z" fill={secondaryfill}/>
...
export default 18px_circleImage;