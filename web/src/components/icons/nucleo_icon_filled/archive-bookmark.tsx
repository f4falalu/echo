...
function archiveBookmark(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="m15.25,0h-2.5c-.9648,0-1.75.7852-1.75,1.75v5.5c0,.3032.1826.5767.4629.6929.2803.1167.6025.0518.8174-.1626l1.7197-1.7197,1.7197,1.7197c.1436.1436.335.2197.5303.2197.0967,0,.1943-.0186.2871-.0571.2803-.1162.4629-.3896.4629-.6929V1.75c0-.9648-.7852-1.75-1.75-1.75Z" fill={secondaryfill} strokeWidth="0"/>
	</g>
</svg>
	);
};
