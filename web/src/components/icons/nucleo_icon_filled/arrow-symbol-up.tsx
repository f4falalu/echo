...
function 18px_arrowSymbolUp(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M13.25,7.75c-.086,0-.174-.015-.26-.046-2.12-.782-3.328-2.12-3.99-3.181-.662,1.061-1.87,2.398-3.99,3.181-.391,.142-.82-.056-.963-.444-.144-.389,.055-.82,.444-.963,3.061-1.129,3.756-3.629,3.784-3.734,.087-.329,.386-.56,.726-.56h.004c.342,.002,.64,.232,.724,.564,.027,.102,.722,2.601,3.783,3.73,.389,.144,.587,.575,.444,.963-.112,.303-.398,.49-.704,.49Z" fill={fill}/>
	</g>
</svg>
	);
};

export default 18px_arrowSymbolUp;