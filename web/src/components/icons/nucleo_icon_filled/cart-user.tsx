...
function 18px_cartUser(props: iconProps) {
	...
	<g fill={fill}>
		...
		<circle cx="14.641" cy="1.75" fill={secondaryfill} r="1.75"/>
		...
		<path d="M14.641,4c-1.48,0-2.802,.943-3.291,2.345-.131,.375-.07,.795,.162,1.123,.237,.333,.621,.532,1.028,.532h4.202c.407,0,.791-.199,1.027-.532,.232-.328,.293-.748,.163-1.123-.489-1.403-1.811-2.346-3.291-2.346Z" fill={secondaryfill}/>
	</g>
</svg>
	);
};
