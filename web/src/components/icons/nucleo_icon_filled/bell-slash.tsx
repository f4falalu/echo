...
function 18px_bellSlash(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M2.25,14h1.75L13.928,4.072c-.899-1.817-2.767-3.072-4.928-3.072C5.967,1,3.5,3.467,3.5,6.5v4.75c0,.689-.561,1.25-1.25,1.25-.414,0-.75,.336-.75,.75s.336,.75,.75,.75Z" fill={fill}/>
		<path d="M15.75,12.5c-.689,0-1.25-.561-1.25-1.25V6.682l-7.318,7.318H15.75c.414,0,.75-.336,.75-.75s-.336-.75-.75-.75Z" fill={fill}/>
