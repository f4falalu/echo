...
function 18px_cropAlphaGrid(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M13.75,17c-.414,0-.75-.336-.75-.75V5.25c0-.138-.112-.25-.25-.25H6.75c-.414,0-.75-.336-.75-.75s.336-.75,.75-.75h6c.965,0,1.75,.785,1.75,1.75v11c0,.414-.336,.75-.75,.75Z" fill={fill}/>
		<path d="M4.25,5H1.75c-.414,0-.75-.336-.75-.75s.336-.75,.75-.75h2.5c.414,0,.75,.336,.75,.75s-.336,.75-.75,.75Z" fill={fill}/>
		<path d="M16.25,14.5H5.25c-.965,0-1.75-.785-1.75-1.75V1.75c0-.414,.336-.75,.75-.75s.75,.336,.75,.75V12.75c0,.138,.112,.25,.25,.25h11c.414,0,.75,.336,.75,.75s-.336,.75-.75,.75Z" fill={fill}/>
	</g>
</svg>
	);
};
