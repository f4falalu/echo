...
function timelineVertical(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="m3.75,8.5h-.75V3.5h.75c.414,0,.75-.336.75-.75s-.336-.75-.75-.75h-.75V.75c0-.414-.336-.75-.75-.75s-.75.336-.75.75v10.5c0,.414.336.75.75.75s.75-.336.75-.75v-1.25h.75c.414,0,.75-.336.75-.75s-.336-.75-.75-.75Z" fill={secondaryfill} strokeWidth="0"/>
	</g>
</svg>
	);
};
