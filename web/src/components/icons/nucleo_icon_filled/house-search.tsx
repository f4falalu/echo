...
function 18px_houseSearch(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M9.5,14c0-2.481,2.019-4.5,4.5-4.5,.722,0,1.395,.187,2,.49v-2.994c0-.543-.258-1.064-.691-1.394L10.059,1.613c-.624-.475-1.495-.474-2.118,0L2.691,5.603s0,0,0,0c-.433,.329-.691,.85-.691,1.393v7.254c0,1.517,1.233,2.75,2.75,2.75h5.92c-.72-.798-1.17-1.843-1.17-3Z" fill={fill}/>
...
export default 18px_houseSearch;