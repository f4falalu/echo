  ...
  return (
    <svg height={height} width={width} viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="m13.25,16H4.75c-1.5166,0-2.75-1.2334-2.75-2.75V4.75c0-1.5166,1.2334-2.75,2.75-2.75h4.7109c.4141,0,.75.3359.75.75s-.3359.75-.75.75h-4.7109c-.6895,0-1.25.5605-1.25,1.25v8.5c0,.6895.5605,1.25,1.25,1.25h8.5c.6895,0,1.25-.5605,1.25-1.25v-7c0-.4141.3359-.75.75-.75s.75.3359.75.75v7c0,1.5166-1.2334,2.75-2.75,2.75Z"
          fill={fill}
          strokeWidth="0"
        />
        <path
