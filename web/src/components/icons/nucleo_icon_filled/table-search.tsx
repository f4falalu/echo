...
function 18px_tableSearch(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M13.25,2H4.75c-1.517,0-2.75,1.233-2.75,2.75V13.25c0,1.519,1.231,2.75,2.75,2.75h4.093c.414,0,.75-.336,.75-.75s-.336-.75-.75-.75h-2.343v-6.5H3.5v-1.5h3V3.5h1.5v3h6.5v2.343c0,.414,.336,.75,.75,.75s.75-.336,.75-.75V4.75c0-1.519-1.231-2.75-2.75-2.75Z" fill={fill}/>
	</g>
</svg>
	);
};
