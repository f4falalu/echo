...
function 18px_borderTopLeft(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M15.25,2H2.75c-.414,0-.75,.336-.75,.75V15.25c0,.414,.336,.75,.75,.75s.75-.336,.75-.75V3.5H15.25c.414,0,.75-.336,.75-.75s-.336-.75-.75-.75Z" fill={secondaryfill}/>
	</g>
</svg>
	);
};

export default 18px_borderTopLeft;