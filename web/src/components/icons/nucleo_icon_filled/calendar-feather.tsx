...
function 18px_calendarFeather(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M13.75,2H4.25c-1.517,0-2.75,1.233-2.75,2.75V13.25c0,1.517,1.233,2.75,2.75,2.75h4.39c.414,0,.75-.336,.75-.75s-.336-.75-.75-.75H4.25c-.689,0-1.25-.561-1.25-1.25V7H15v1.458c0,.414,.336,.75,.75,.75s.75-.336,.75-.75v-3.708c0-1.517-1.233-2.75-2.75-2.75Z" fill={fill}/>
...
export default 18px_calendarFeather;