...
function 18px_userAlert(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M7.22,16.819c-.571-1.042-.532-2.307,.101-3.307l2.797-4.416c-.366-.059-.738-.096-1.117-.096-2.765,0-5.274,1.636-6.395,4.167-.257,.58-.254,1.245,.008,1.825,.268,.592,.777,1.043,1.399,1.239,1.064,.335,2.155,.551,3.258,.667-.016-.027-.036-.052-.051-.079Z" fill={fill}/>
