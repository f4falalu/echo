...
function 18px_fileFeather(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M8.515,16.995c.302-2.544,2.259-7.33,7.485-8.338v-1.993c0-.467-.182-.907-.513-1.237l-3.914-3.914c-.331-.331-.77-.513-1.237-.513H4.75c-1.517,0-2.75,1.233-2.75,2.75V14.25c0,1.517,1.233,2.75,2.75,2.75h3.765s0-.003,0-.005Zm1.985-14.417c.009-.004,.004-.001,.013-.005l3.922,3.921s-.001,.003-.002,.005h-2.932c-.55,0-1-.45-1-1V2.579Zm-4.75,3.421h2c.414,0,.75,.336,.75,.75s-.336,.75-.75,.75h-2c-.414,0-.75-.336-.75-.75s.336-.75,.75-.75Zm-.75,3.75c0-.414,.336-.75,.75-.75h4.5c.414,0,.75,.336,.75,.75s-.336,.75-.75,.75H5.75c-.414,0-.75-.336-.75-.75Z" fill={fill}/>
	</g>
</svg>
	);
};

export default 18px_fileFeather;