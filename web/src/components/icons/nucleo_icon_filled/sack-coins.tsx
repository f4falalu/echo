...
function 18px_sackCoins(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M4.599,4h2.401v-.75c0-.414,.336-.75,.75-.75s.75,.336,.75,.75v.75h2.401l1.223-1.834c.082-.123,.126-.268,.126-.416,0-.965-.785-1.75-1.75-1.75H5c-.965,0-1.75,.785-1.75,1.75,0,.148,.044,.293,.126,.416l1.223,1.834Z" fill={fill}/>
		<path d="M8.5,15.25v-.658c-.627-.602-1-1.443-1-2.342v-1c0-.899,.373-1.74,1-2.342v-.658c0-1.162,.618-2.175,1.537-2.75H3.85c-1.683,1.705-2.85,4.213-2.85,6.5s1.171,5,6.75,5c.444,0,.85-.023,1.24-.056-.305-.495-.49-1.072-.49-1.694Z" fill={fill}/>
