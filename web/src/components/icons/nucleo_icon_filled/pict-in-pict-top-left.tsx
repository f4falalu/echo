...
function 18px_pictInPictTopLeft(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M13.5,9.75c0-.414-.336-.75-.75-.75h-3c-.098,0-.195,.02-.287,.058-.183,.076-.329,.222-.405,.406-.038,.092-.058,.189-.058,.287v3c0,.414,.336,.75,.75,.75s.75-.336,.75-.75v-1.189l1.47,1.47c.146,.146,.338,.22,.53,.22s.384-.073,.53-.22c.293-.293,.293-.768,0-1.061l-1.47-1.47h1.189c.414,0,.75-.336,.75-.75Z" fill={secondaryfill}/>
