...
function 18px_grid3(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<rect height="4" width="4" fill={secondaryfill} rx="1.5" ry="1.5" strokeWidth="0" x="7" y="2"/>
		...
		<rect height="4" width="4" fill={secondaryfill} rx="1.5" ry="1.5" strokeWidth="0" x="2" y="7"/>
		<rect height="4" width="4" fill={secondaryfill} rx="1.5" ry="1.5" strokeWidth="0" x="12" y="7"/>
		<rect height="4" width="4" fill={secondaryfill} rx="1.5" ry="1.5" strokeWidth="0" x="7" y="12"/>
