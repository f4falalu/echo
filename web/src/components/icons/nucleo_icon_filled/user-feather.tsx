...
function userFeather(props: iconProps) {
	...
	const title = props.title || "user feather";
	...
	<g fill={fill}>
		...
		<path d="M12.654,10.045c-1.08-.664-2.335-1.045-3.654-1.045-2.764,0-5.274,1.636-6.395,4.167-.257,.58-.254,1.245,.008,1.825,.268,.591,.777,1.043,1.399,1.239,1.464,.461,2.977,.706,4.504,.75,.229-1.905,1.389-5.048,4.137-6.936Z" fill={fill}/>
