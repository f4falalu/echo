...
function 18px_calendarEvent(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M11.25,12.5c-.965,0-1.75-.785-1.75-1.75s.785-1.75,1.75-1.75,1.75,.785,1.75,1.75-.785,1.75-1.75,1.75Zm0-2c-.138,0-.25,.112-.25,.25,0,.275,.5,.275,.5,0,0-.138-.112-.25-.25-.25Z" fill={secondaryfill}/>
...
export default 18px_calendarEvent;