...
>(({ className, children, icon, secondaryChildren, index, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'relative flex w-full cursor-default items-center justify-between rounded-sm px-2 py-1.5 text-sm outline-none select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
      className
    )}
    {...props}>
