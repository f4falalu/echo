    ...
    >
      ...
      <g fill="#212121">
        ...
        <path
          ...
          fill="#212121"
        />
        <circle cx="15.25" cy="8.998" fill="#212121" r=".75" />
        <circle cx="12.125" cy="8.998" fill="#212121" r=".75" />
        <circle cx="9" cy="8.998" fill="#212121" r=".75" />
        <circle cx="5.875" cy="8.998" fill="#212121" r=".75" />
        <circle cx="2.75" cy="8.998" fill="#212121" r=".75" />
      </g>
    </svg>
  );
}
