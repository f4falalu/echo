  ...
  return (
    <svg height={height} width={width} viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M6.25,17c-2.068,0-3.75-1.682-3.75-3.75,0-.414,.336-.75,.75-.75s.75,.336,.75,.75c0,1.241,1.009,2.25,2.25,2.25,.414,0,.75,.336,.75,.75s-.336,.75-.75,.75Z"
          fill={secondaryfill}
        />
        <path
          d="M14.75,5.5c-.414,0-.75-.336-.75-.75,0-1.241-1.009-2.25-2.25-2.25-.414,0-.75-.336-.75-.75s.336-.75,.75-.75c2.068,0,3.75,1.682,3.75,3.75,0,.414-.336,.75-.75,.75Z"
          fill={secondaryfill}
        />
      </g>
    </svg>
