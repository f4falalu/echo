...
function messageLock(props: iconProps) {
  ...
  return (
    <svg height="1em" width="1em" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill="currentColor">
        <path
          d="M9,13.75c0-1.129,.597-2.149,1.507-2.732,.12-1.96,1.753-3.518,3.743-3.518,1.091,0,2.064,.479,2.75,1.225V4.25c0-1.517-1.233-2.75-2.75-2.75H3.75c-1.517,0-2.75,1.233-2.75,2.75v7c0,1.517,1.233,2.75,2.75,2.75h1.25v2.25c0,.288,.165,.551,.425,.676,.103,.05,.214,.074,.325,.074,.167,0,.333-.056,.469-.165l2.781-2.225v-.861Z"
          fill="currentColor"
        />
        <path
