...
function handHoldingKey(props: iconProps) {
  ...
  return (
    <svg height="1em" width="1em" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill="currentColor">
        <path
          d="M16.25,3h-6.367c-.329-1.151-1.378-2-2.633-2-1.517,0-2.75,1.233-2.75,2.75s1.233,2.75,2.75,2.75c1.255,0,2.304-.849,2.633-2h2.117v1.25c0,.414,.336,.75,.75,.75s.75-.336,.75-.75v-1.25h.75v1.25c0,.414,.336,.75,.75,.75s.75-.336,.75-.75v-1.25h.5c.414,0,.75-.336,.75-.75s-.336-.75-.75-.75ZM7.25,5c-.689,0-1.25-.561-1.25-1.25s.561-1.25,1.25-1.25,1.25,.561,1.25,1.25-.561,1.25-1.25,1.25Z"
          fill="currentColor"
        />
        <path
