...
function chatBubbleStar(props: iconProps) {
  ...
  return (
    <svg height={height} width={width} viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill={fill}>
        <path
          d="M8.609,11.735c.268-.822,.964-1.409,1.817-1.533l1.075-.156,.481-.974c.371-.752,1.144-1.22,2.018-1.22s1.647,.468,2.018,1.221l.48,.973h.001s0-5.296,0-5.296c0-1.517-1.233-2.75-2.75-2.75H4.25c-1.517,0-2.75,1.233-2.75,2.75v11.5c0,.288,.165,.551,.425,.676,.103,.05,.214,.074,.325,.074,.167,0,.333-.056,.469-.165l3.544-2.835h2.885c-.589-.6-.799-1.46-.539-2.265Z"
          fill={fill}
        />
        <path
