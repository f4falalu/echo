  ...
  return (
    ...
    >
      ...
      <g fill="#212121">
        ...
        <circle cx="5.875" cy="2.75" fill="#212121" r=".75" strokeWidth="0" />
        <circle cx="2.75" cy="2.75" fill="#212121" r=".75" strokeWidth="0" />
        <circle cx="5.875" cy="15.25" fill="#212121" r=".75" strokeWidth="0" />
        <circle cx="2.75" cy="15.25" fill="#212121" r=".75" strokeWidth="0" />
        <circle cx="2.75" cy="12.125" fill="#212121" r=".75" strokeWidth="0" />
        <circle cx="2.75" cy="5.875" fill="#212121" r=".75" strokeWidth="0" />
      </g>
    </svg>
  );
}
