    ...
    >
      ...
      <g fill="#212121">
        <path
          ...
          fill="#212121"
        />
        <circle cx="9" cy="9" fill="#212121" r="2" />
        <circle cx="3.25" cy="5.5" fill="#212121" r="2" />
        <circle cx="3.25" cy="12.5" fill="#212121" r="2" />
        <circle cx="14.75" cy="5.5" fill="#212121" r="2" />
        <circle cx="14.75" cy="12.5" fill="#212121" r="2" />
        <circle cx="9" cy="2.25" fill="#212121" r="2" />
        <circle cx="9" cy="15.75" fill="#212121" r="2" />
      </g>
    </svg>
  );
}
