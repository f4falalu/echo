  ...
  return (
    <svg height={height} width={width} viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="M12.25,4.5c-.079,0-.159-.012-.237-.039-.393-.131-.605-.556-.474-.949l.75-2.25c.13-.393,.555-.606,.949-.474,.393,.131,.605,.556,.474,.949l-.75,2.25c-.104,.314-.397,.513-.711,.513Z"
          fill={secondaryfill}
        />
        <path
          d="M14.25,6.5c-.314,0-.607-.199-.711-.513-.131-.393,.081-.818,.474-.949l2.25-.75c.394-.131,.818,.082,.949,.474,.131,.393-.081,.818-.474,.949l-2.25,.75c-.079,.026-.159,.039-.237,.039Z"
          fill={secondaryfill}
        />
        <path
          d="M1.5,13.75c-.314,0-.607-.199-.711-.513-.131-.393,.081-.818,.474-.949l2.25-.75c.394-.132,.818,.082,.949,.474,.131,.393-.081,.818-.474,.949l-2.25,.75c-.079,.026-.159,.039-.237,.039Z"
          fill={secondaryfill}
        />
        <path
          d="M5,17.25c-.079,0-.159-.012-.237-.039-.393-.131-.605-.556-.474-.949l.75-2.25c.13-.393,.556-.606,.949-.474,.393,.131,.605,.556,.474,.949l-.75,2.25c-.104,.314-.397,.513-.711,.513Z"
          fill={secondaryfill}
        />
      </g>
    </svg>
