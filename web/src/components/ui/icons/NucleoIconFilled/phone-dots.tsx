...
function phoneDots(props: iconProps) {
  ...
  return (
    ...
    >
      ...
      <g fill="#212121">
        <path
          d="M13,5c-.551,0-1-.449-1-1s.449-1,1-1,1,.449,1,1-.449,1-1,1Z"
          fill="#212121"
        />
        <path
          d="M10,5c-.551,0-1-.449-1-1s.449-1,1-1,1,.449,1,1-.449,1-1,1Z"
          fill="#212121"
        />
        <path
          d="M16,5c-.551,0-1-.449-1-1s.449-1,1-1,1,.449,1,1-.449,1-1,1Z"
          fill="#212121"
        />
        <path
