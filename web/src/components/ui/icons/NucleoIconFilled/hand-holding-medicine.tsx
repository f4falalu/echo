...
function handHoldingMedicine(props: iconProps) {
  ...
  return (
    <svg height={height} width={width} viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill={fill}>
        <path
          d="M15.986,2.888c-.386-.664-1.008-1.137-1.75-1.333l-3.625-.958c-.744-.197-1.517-.092-2.181,.294-.664,.386-1.137,1.008-1.333,1.75-.196,.743-.092,1.517,.294,2.181s1.007,1.138,1.75,1.334l3.625,.958c.245,.065,.491,.096,.733,.096,1.273,0,2.44-.853,2.781-2.141,.196-.742,.091-1.517-.295-2.181Zm-7.299,1.179c-.185-.317-.235-.688-.141-1.043,.094-.355,.32-.652,.638-.837,.212-.124,.449-.187,.688-.187,.118,0,.237,.015,.354,.046l1.813,.478-.703,2.659-1.812-.478c-.355-.094-.653-.321-.837-.638Z"
          fill={secondaryfill}
        />
        <path
