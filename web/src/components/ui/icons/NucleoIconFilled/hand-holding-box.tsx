...
function handHoldingBox(props: iconProps) {
  ...
  return (
    <svg height={height} width={width} viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill={fill}>
        <path
          d="M8.524,7.093l2.795,1.277c.348,.158,.649,.38,.925,.63h1.005c1.517,0,2.75-1.233,2.75-2.75V2.75c0-1.517-1.233-2.75-2.75-2.75h-1.25V2.75c0,.414-.336,.75-.75,.75s-.75-.336-.75-.75V0h-1.25c-1.517,0-2.75,1.233-2.75,2.75v3.5c0,.118,.02,.231,.035,.346,.671,.046,1.339,.208,1.989,.498Z"
          fill={secondaryfill}
        />
        <path
