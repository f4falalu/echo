...
function satellite(props: iconProps) {
  ...
  return (
    <svg height={height} width={width} viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill={fill}>
        <path
          d="M7.25,13c-1.241,0-2.25-1.009-2.25-2.25,0-.414-.336-.75-.75-.75s-.75,.336-.75,.75c0,2.068,1.682,3.75,3.75,3.75,.414,0,.75-.336,.75-.75s-.336-.75-.75-.75Z"
          fill={secondaryfill}
        />
        <path
          d="M7.25,16c-2.895,0-5.25-2.355-5.25-5.25,0-.414-.336-.75-.75-.75s-.75,.336-.75,.75c0,3.722,3.028,6.75,6.75,6.75,.414,0,.75-.336,.75-.75s-.336-.75-.75-.75Z"
          fill={secondaryfill}
        />
        <path
