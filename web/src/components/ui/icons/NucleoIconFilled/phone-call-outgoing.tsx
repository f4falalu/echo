...
function phoneCallOutgoing(props: iconProps) {
  ...
  return (
    <svg height={height} width={width} viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill={fill}>
        <path
          d="M10.75,8c.192,0,.384-.073,.53-.22l3.22-3.22v1.689c0,.414,.336,.75,.75,.75s.75-.336,.75-.75V2.75c0-.414-.336-.75-.75-.75h-3.5c-.414,0-.75,.336-.75,.75s.336,.75,.75,.75h1.689l-3.22,3.22c-.293,.293-.293,.768,0,1.061,.146,.146,.338,.22,.53,.22Z"
          fill={secondaryfill}
        />
        <path
