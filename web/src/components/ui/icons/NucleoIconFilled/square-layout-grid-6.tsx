...
function squareLayoutGrid6(props: iconProps) {
  ...
  return (
    ...
    >
      <title>{title}</title>
      <g fill="#212121">
        <path d="M7 2H11V5.5H7z" fill="#212121" />
        <path d="M2 7H5.5V11H2z" fill="#212121" />
        <path d="M12.5 7H16V11H12.5z" fill="#212121" />
        <path d="M7 12.5H11V16H7z" fill="#212121" />
        <path d="M7 7H11V11H7z" fill="#212121" />
        <path
