...
function I12px_lifeRing(props: iconProps) {
  ...
  return (
    <svg height={height} width={width} viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="m6,9c-1.654,0-3-1.346-3-3s1.346-3,3-3,3,1.346,3,3-1.346,3-3,3Zm0-4.5c-.827,0-1.5.673-1.5,1.5s.673,1.5,1.5,1.5,1.5-.673,1.5-1.5-.673-1.5-1.5-1.5Z"
          fill={fill}
          strokeWidth="0"
        />
      </g>
