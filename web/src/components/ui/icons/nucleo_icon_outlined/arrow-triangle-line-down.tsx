...
function arrowTriangleLineDown(props: iconProps) {
	...
	<g fill={fill}>
		...
		<path d="M9.414,15.547l3.058-4.516c.225-.332-.013-.78-.414-.78H5.942c-.401,0-.639,.448-.414,.78l3.058,4.516c.198,.293,.63,.293,.828,0Z" fill="none" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
	</g>
</svg>
	);
};
