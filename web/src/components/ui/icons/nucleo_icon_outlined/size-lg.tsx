...
function sizeLg(props: iconProps) {
	...
	<g fill={fill}>
		...
		<rect height="12.5" width="5.5" fill="none" rx="1" ry="1" stroke={fill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth} x="9.75" y="2.75"/>
	</g>
</svg>
	);
};
