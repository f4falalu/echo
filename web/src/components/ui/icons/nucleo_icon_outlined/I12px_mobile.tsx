...
function I12px_mobile(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M7.25 3.25L4.75 3.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
