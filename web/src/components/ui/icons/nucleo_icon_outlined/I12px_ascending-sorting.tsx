...
function I12px_ascendingSorting(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M8.75 4.25L8.75 11.25" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M11.25 6.5L8.75 4 6.25 6.5" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
...
export default I12px_ascendingSorting;