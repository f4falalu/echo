...
function I12px_squareDashedPlus(props: iconProps) {
  ...
  return (
    <svg height={height} width={width} viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill={fill}>
        ...
        />
        <path
          d="m8.25,5.25h-1.5v-1.5c0-.414-.336-.75-.75-.75s-.75.336-.75.75v1.5h-1.5c-.414,0-.75.336-.75.75s.336.75.75.75h1.5v1.5c0,.414.336.75.75.75s.75-.336.75-.75v-1.5h1.5c.414,0,.75-.336.75-.75s-.336-.75-.75-.75Z"
          fill={secondaryfill}
          strokeWidth="0"
        />
      </g>
...
export default I12px_squareDashedPlus;
