...
function chevronUpRightDownLeft(props: iconProps) {
	...
	<title>{title}</title>
	<g fill={fill}>
		<path d="M4.5 11.25L2.25 9 4.5 6.75" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
		<path d="M13.5 11.25L15.75 9 13.5 6.75" fill="none" stroke={secondaryfill} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokewidth}/>
