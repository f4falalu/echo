...
function sneeze(props: iconProps) {
  ...
  return (
    ...
    >
      <title>{title}</title>
      <g fill="#212121">
        <circle cx="6.25" cy="7.25" fill="#212121" r=".75" />
        <circle cx="12.75" cy="11.75" fill="#212121" r=".75" />
        <circle cx="15.25" cy="9.75" fill="#212121" r=".75" />
        <circle cx="15.25" cy="13.75" fill="#212121" r=".75" />
        <path
