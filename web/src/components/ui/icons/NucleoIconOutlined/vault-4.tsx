...
function vault4(props: iconProps) {
  ...
  return (
    ...
    >
      <title>{title}</title>
      <g fill="#212121">
        <circle cx="12.25" cy="12.75" fill="#212121" r=".75" />
        <circle cx="9.75" cy="12.75" fill="#212121" r=".75" />
        <circle cx="12.25" cy="10.25" fill="#212121" r=".75" />
        <circle cx="9.75" cy="10.25" fill="#212121" r=".75" />
        <path
          d="M1.25 9L3.25 9"
          fill="none"
          stroke="#212121"
