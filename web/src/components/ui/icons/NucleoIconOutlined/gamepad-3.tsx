...
function gamepad3(props: iconProps) {
  ...
  return (
    ...
    >
      <title>{title}</title>
      <g fill="#212121">
        <circle cx="10.75" cy="7.25" fill="#212121" r=".75" />
        <circle cx="13.75" cy="7.25" fill="#212121" r=".75" />
        <circle cx="12.25" cy="6" fill="#212121" r=".75" />
        <circle cx="12.25" cy="8.5" fill="#212121" r=".75" />
        <circle cx="5.75" cy="11.5" fill="#212121" r="1.5" />
        <circle cx="12.25" cy="11.5" fill="#212121" r="1.5" />
        <path
          d="M5.75 6L5.75 8.5"
          fill="none"
          stroke="#212121"
