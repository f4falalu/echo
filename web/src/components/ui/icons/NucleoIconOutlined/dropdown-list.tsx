  ...
  return (
    <svg height="1em" width="1em" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      ...
      <g fill="currentColor">
        ...
        />
        <path
          d="M14.75,9.25v-2c0-.828-.672-1.5-1.5-1.5H3.75c-.828,0-1.5,.672-1.5,1.5v2c0,.828,.672,1.5,1.5,1.5h4.5"
          fill="none"
          stroke="#212121"
          strokeLinecap="round"
          strokeLinejoin="round"
