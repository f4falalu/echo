...
function gamepad5(props: iconProps) {
  ...
  return (
    ...
    >
      <title>{title}</title>
      <g fill="#212121">
        <circle cx="10.25" cy="7.5" fill="#212121" r=".75" />
        <circle cx="13.25" cy="7.5" fill="#212121" r=".75" />
        <circle cx="11.75" cy="6.25" fill="#212121" r=".75" />
        <circle cx="11.75" cy="8.75" fill="#212121" r=".75" />
        <circle cx="6" cy="7.5" fill="#212121" r="1" />
        <path
